...
SHOTS = [
    ("f640f635-suarfotos439.jpeg",          1, "THE ROOM",        0.50, 0.15),  # keep balcony up top
    ("b363ef58-suarfotos511.jpeg",          2, "THE BAND",        0.50, 0.45),
    ("fa816dbd-suarfotos520.jpeg",          3, "YOU, MID-SONG",   0.50, 0.30),  # keep raised hand
    ("3b2c58b3-suarfotos546_1.jpeg",        4, "GUEST VOCALIST",  0.55, 0.45),
    ("95048462-suarfotos526.jpeg",          5, "HERO LEAN",       0.50, 0.45),
    ("3b07bb89-suarfotos524.jpeg",          6, "CROWD CONNECT",   0.42, 0.55),  # keep you + fan/strip
    ("73354ab7-suarfotos533.jpeg",          7, "CONFETTI CLIMAX", 0.46, 0.45),
    ("544b11d4-Droga5_Reunion_6.9.26_pictureplastic__Mark_Minton136.jpeg", 8, "BEHIND THE SCENES", 0.55, 0.40),
]
...
d.text((PAD, 18), "IG STORY SET — 8 slots, 9:16  (narrative: room → band → you → guest → peak → crowd → climax → close)",
